      ...
      <div className="container mx-auto px-4 py-16 mt-10">
        ...
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h1 className="text-4xl font-bold mb-8 font-serif">Disclaimer</h1>
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p>
                ...
                examples. If you rely upon our figures, you must accept the risk
                of not doing as well.
              </p>
              <p>
                Your results will vary depending on your personal abilities,
                experience, knowledge, capabilities, level of desire, and
                individual application. Success in any business also depends on
                your dedication, education, and willingness to work.
              </p>

              <h2>3. Testimonials</h2>
              <p>
                Testimonials found on our website are experiences related to us
                by our users, and may not reflect the typical purchaser's
                experience, may not apply to the average person, and are not
                intended to represent or guarantee that anyone will achieve the
                same or similar results.
              </p>

              <h2>4. High-Risk Investment Warning</h2>
              <p>
                Trading and investing involve a significant risk to your
                invested capital. Please ensure you fully understand the risks
                involved and manage them effectively. Do not invest money you
